...
<html xmlns:MadCap="http://www.madcapsoftware.com/Schemas/MadCap.xsd" MadCap:lastBlockDepth="7" MadCap:lastHeight="271" MadCap:lastWidth="756">
    <head>
        ...
        <script>/*<![CDATA[*/</script>
			...
			<script src="/assets/js/cshidAccordian.js"></script>
		<script>/*]]>*/</script>
    ...
    <body>
      ...
      <nav class="navbar navbar-default topnav fullnav" role="navigation">
        ...
        <script src="/assets/js/cshidAccordian.js">
        </script>
